...
//! Invalid inputs to async functions can lead to the scripts being stuck
//! without Bitburner being able to automatically kill them and propagate the
//! errors. For this reason they are marked unsafe. Make sure to validate inputs
//! before calling them.
